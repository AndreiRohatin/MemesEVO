...
var OBJ_RIGHT = 4;
var GRAPHICS = {};
GRAPHICS.running_left = "running_left.gif";
GRAPHICS.running_right = "running_right.gif";
GRAPHICS.jumping_left = "jumping_left.gif";
GRAPHICS.jumping_right = "jumping_right.gif";
GRAPHICS.standing_left = "standing_left.gif";
GRAPHICS.standing_right = "standing_right.gif";
GRAPHICS.ground_brick = "ground_brick.png";
GRAPHICS.ground_pipe = "ground_pipe.gif";
GRAPHICS.question_block = "question_block.gif";
GRAPHICS.block_brick = "block_brick.gif";
GRAPHICS.moving_block = "moving_block.png";
GRAPHICS.mushroom_head = "mushroom_head.gif";
GRAPHICS.coin = "coin.gif";
GRAPHICS.small_brick = "small_brick.png";
...
function gravity(){
	if (!bOnSurface)
		posY+=gravity_const;
	gravity_const++;
	if (gravity_const>GRAVITY_CAP) gravity_const = GRAVITY_CAP; //put cap on falling speed;
}
...
$(document).ready(function(){
	...
	setTimeout(function(){
		...
		setInterval(function(){debugUpdate();},1000);
